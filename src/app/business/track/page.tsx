...
const Page = () => {
  return (
    ...
    >
      ...
      <div className=' max-w-[1440px] mx-auto md:w-fit flex md:flex-row lg:flex lg:flex-row justify-center items-center lg:justify-around flex-col lg:mt-0  mt-8 gap-16 md:gap-4 lg:gap-16'>
