  ...
  return (
    ...
    <footer className="bg-[#122957] text-gray-300 pt-8 pb-6 px-6 relative z-20 font-monte bottom-0">
      ...
      <div className="max-w-none 2xl:max-w-[1600px] mx-auto text-center text-gray-400 text-sm ">
        Designed By <Link href={'https://www.linkedin.com/in/sayan-sarkarr-96ba64174/'}>Sayan Sarkar</Link> <br className="md:hidden"/> <span className="hidden md:inline">|</span> © 2025 Anjali Elastomer Ltd. All rights reserved. <br className="md:hidden"/><span className="hidden md:inline">|</span> Developed By <Link href={'https://www.resourcio.in/'}>Resourcio</Link>
      </div>
    </footer>
  );
};
