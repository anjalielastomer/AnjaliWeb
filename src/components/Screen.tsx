  ...
  return (
    <>
      ...
      <div
        ...
        className="pointer-events-none absolute left-0 top-0 will-change-transform origin-top-left w-[588.55224609375px] h-[664.03076171875px] opacity-100 rounded-none"
        style={{
          transform:
