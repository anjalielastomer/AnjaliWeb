  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:block justify-center items-center h-full gap-6 px-4 sm:px-8">
        ...
        <div className="group flex flex-col gap-6 md:gap-8 max-w-lg bg-white/20 backdrop-blur-md rounded-xl px-8 py-8 sm:px-10 sm:py-10 md:px-12 md:py-12 shadow-lg transition duration-300 hover:bg-orange-500 hover:shadow-2xl
