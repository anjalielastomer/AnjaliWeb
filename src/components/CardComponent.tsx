...
const CardComponent = ({ data }: { data: CardProps }) => {
  return (
    <div className="border bg-white hover:bg-[#FFF5EF] hover:border-none border-[#FB7602] shadow-lg hover:shadow-[0_0_10px_rgba(255,165,0,0.4)] transition-shadow duration-300 min-h-70 p-2 md:p-8 xl:-mt-6 rounded-lg ">
