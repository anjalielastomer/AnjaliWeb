...
interface AnimationTrack<PropTrackKey, Value> {
  ...
  interface Timeline {
    ...
    let animationComposerPromise: Promise<void> | null = null
      ...
      const propToWebMap = {"motionPath":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${_.pos[0]}px, ${_.pos[1]}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${se(0)}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"rotation":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${_*180/Math.PI}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${se(0)}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"scaleX":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${_}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"scaleY":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${se(0)}, ${_}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"skewX":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${_*180/Math.PI}deg, ${ae(2,1)}deg) scale(${se(0)}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"skewY":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${_*180/Math.PI}deg) scale(${se(0)}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"contentAnchor":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${se(0)}, ${se(1)}) translate(${-_.contentAnchorX}px, ${-_.contentAnchorY}px) translate(${ae(5,0)}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"width":[{"selector":"te=>`[data-ph-geometry-id=\"${te}\"]`","svg":{"type":"style","key":"width","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}},{"selector":"te=>`[data-ph-id=\"${te}\"]`","dom":{"type":"style","key":"width","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}},{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${se(0)}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(6,0)*_}px, ${ae(5,1)}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"height":[{"selector":"te=>`[data-ph-geometry-id=\"${te}\"]`","svg":{"type":"style","key":"height","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}},{"selector":"te=>`[data-ph-id=\"${te}\"]`","dom":{"type":"style","key":"height","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}},{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"transform","fn":"(te,_)=>{const ne=le=>{const de=le.match(/\\w+\\([^)]*\\)/g)||[],pe=(De=\"\")=>(De.match(/[-+]?\\d*\\.?\\d+(?:e[-+]?\\d+)?/g)||[]).map(parseFloat),fe=Array.from({length:8},(De,ve)=>pe(de[ve]));return{xy:(De,ve,Ae=0)=>fe[De][ve]??Ae,sc:De=>fe[3][De]??fe[3][0]??1}},{xy:ae,sc:se}=ne(te);return`translate(${ae(0,0)}px, ${ae(0,1)}px) rotate(${ae(1,0)}deg) skew(${ae(2,0)}deg, ${ae(2,1)}deg) scale(${se(0)}, ${se(1)}) translate(${ae(4,0)}px, ${ae(4,1)}px) translate(${ae(5,0)}px, ${ae(6,1)*_}px) translate(${ae(6,0)}px, ${ae(6,1)}px) translate(${ae(7,0)}px, ${ae(7,1)}px)`}"}}],"opacity":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"opacity","fn":"(te=\"0\",_)=>`${_}`"}}],"blendMode":[],"cornerRadius":[],"fontSize":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"fontSize","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}}],"lineHeight":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"lineHeight","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}}],"letterSpacing":[{"selector":"te=>`[data-ph-id=\"${te}\"]`","rule":{"type":"style","key":"letterSpacing","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}}],"pathMorphing":[],"fills.paint":[{"selector":"(te,_)=>`[data-ph-layer-id=\"${te}-fills-${_}\"]`","dom":{"type":"style","key":"backgroundColor","fn":"(te,_)=>{const ne=(ae,se=1)=>{const le=Math.round(ae[0]*255),de=Math.round(ae[1]*255),pe=Math.round(ae[2]*255);return`rgba(${le}, ${de}, ${pe}, ${se})`};switch(_.type){case 0:return`${ne(_.color,1)}`;case 1:return te;case 2:return te}}"},"domText":{"type":"style","key":"color","fn":"(te,_)=>{const ne=(ae,se=1)=>{const le=Math.round(ae[0]*255),de=Math.round(ae[1]*255),pe=Math.round(ae[2]*255);return`rgba(${le}, ${de}, ${pe}, ${se})`};switch(_.type){case 0:return`${ne(_.color,1)}`;case 1:return te;case 2:return te}}"},"svg":{"type":"style","key":"fill","fn":"(te,_)=>{const ne=(ae,se=1)=>{const le=Math.round(ae[0]*255),de=Math.round(ae[1]*255),pe=Math.round(ae[2]*255);return`rgba(${le}, ${de}, ${pe}, ${se})`};switch(_.type){case 0:return`${ne(_.color,1)}`;case 1:return te;case 2:return te}}"}}],"fills.opacity":[{"selector":"(te,_)=>`[data-ph-layer-id=\"${te}-fills-${_}\"]`","dom":{"type":"style","key":"opacity","fn":"(te=\"0\",_)=>`${_}`"},"svg":{"type":"style","key":"fillOpacity","fn":"(te=\"0\",_)=>`${_}`"}}],"strokes.paint":[{"selector":"(te,_)=>`[data-ph-layer-id=\"${te}-strokes-${_}\"]`","dom":{"type":"style","key":"borderColor","fn":"(te,_)=>{const ne=(ae,se=1)=>{const le=Math.round(ae[0]*255),de=Math.round(ae[1]*255),pe=Math.round(ae[2]*255);return`rgba(${le}, ${de}, ${pe}, ${se})`};switch(_.type){case 0:return`${ne(_.color,1)}`;case 1:return console.warn(\"strokePaintToCSS: not support gradient\"),te;case 2:return te}}"},"svg":{"type":"style","key":"stroke","fn":"(te,_)=>{const ne=(ae,se=1)=>{const le=Math.round(ae[0]*255),de=Math.round(ae[1]*255),pe=Math.round(ae[2]*255);return`rgba(${le}, ${de}, ${pe}, ${se})`};switch(_.type){case 0:return`${ne(_.color,1)}`;case 1:return te;case 2:return te}}"}}],"strokes.opacity":[{"selector":"(te,_)=>`[data-ph-layer-id=\"${te}-strokes-${_}\"]`","dom":{"type":"style","key":"opacity","fn":"(te=\"0\",_)=>`${_}`"},"svg":{"type":"style","key":"strokeOpacity","fn":"(te=\"0\",_)=>`${_}`"}}],"strokes.dash":[],"strokes.gap":[],"strokes.join":[],"strokes.miter":[],"strokes.ends":[],"strokes.width":[{"selector":"(te,_)=>`[data-ph-layer-id=\"${te}-fills-${_}\"]`","dom":{"type":"style","key":"borderWidth","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"},"svg":{"type":"style","key":"strokeWidth","fn":"(te=\"0px\",_)=>`${_}${(te.match(/[a-z%]+$/i)||[\"px\"])[0]}`"}},{"selector":"(te,_)=>`[data-ph-layer-id=\"${te}-fills-${_}\"]`","dom":{"type":"style","key":"margin","fn":"(te,_)=>`-${_/2}px`"}}],"trimPath.start":[],"trimPath.end":[],"trimPath.offset":[]}
      const domTagNames: string[] = ["div", "p"]
      const domTextTagNames: string[] = ["p"]
      const svgTagNames: string[] = ["svg", "ellipse", "rect", "path", "text", "use", "g"]
      ...
      function createStore(): AnimationStore {
        class AC extends (window as any).AnimationComposer {
          ...
          if (type === "style") {
            const original = (element as HTMLElement | SVGElement).style[styleKey as any]
